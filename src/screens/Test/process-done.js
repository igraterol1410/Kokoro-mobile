      ...
      <div className={styles.inner}>
        ...
        >
          <div className="text-center">
            <h4 className={styles.danger}>Proceso completado</h4>
            <h2 className={styles.bkd}>
              Muchas gracias por completar tu proceso
            </h2>
            <img src="/images/svg/pfx.svg" alt="" className=" mb-58" />
          </div>
